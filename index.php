        ...
        <div class="container clearfix">
          ...
          <div class="footer-nav__col footer-nav__col--contacts">
            ...
            <address class="address">
              Head Office: TARUMT Perak Branch.<br>
              Jln Kolej, Taman Bandar Baru,
              31900 Kampar, Perak
            </address>
            <div class="phone">
              Telephone:
              <a class="phone__number" href="tel:0123456789">012-3456789</a>
            </div>
            <div class="email">
              Email:
              <a href="mailto:support@tarumt.com" class="email__addr">support@tarumt.com</a>
            </div>
          </div>
